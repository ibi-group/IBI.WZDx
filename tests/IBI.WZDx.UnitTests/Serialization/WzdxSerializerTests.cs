...
public class WzdxSerializerTests
{
    ...
    public class DeviceFeedTests
    {
        ...
        {
            Func<DeviceFeed> action = () => WzdxSerializer.DeserializeFeed<DeviceFeed>(TestValidDeviceFeed);
        ...
        {
            var actualFeedObject = WzdxSerializer.DeserializeFeed<DeviceFeed>(feedJson);
            ...
            )
        {
            ...
            string expectedFeedJsonWithoutWhitespace = new(
                expectedFeedJson.Where(c => !char.IsWhiteSpace(c)).ToArray()
                );
            string actualFeedJsonWithoutWhitespace = new(
                            ...
                            new FieldDeviceFeature(
                                ...
                                Properties: new ArrowBoard(
                                    CoreDetails: new FieldDeviceCoreDetails(
                                        ...
                                        Milepost: 15.1,
                                        StatusMessages: ["Arrow board is operational."],
                                        IsMoving: false,
                                        RoadEventIds: ["1f334f6b-14ad-4123-b92d-9d4a7e416629"],
                                        Make: "Ver-Mac",
                                        Model: "AB-1",
        ...
        private const string TestValidDeviceFeed = """
            {
                "feed_info": {
    ...
    public class WorkZoneFeedTests
    {
        ...
        public void DeserializeFeed_JsonValid_DoesNotThrowException()
        {
            Func<WorkZoneFeed> action = () => WzdxSerializer.DeserializeFeed<WorkZoneFeed>(TestValidWorkZoneFeed);
        ...
        {
            var actualFeedObject = WzdxSerializer.DeserializeFeed<WorkZoneFeed>(feedJson);
                ...
                new object[]
                {
                    new WorkZoneFeed(
                        ...
                        [
                            ...
                            new RoadEventFeature(
                                Id: "4b2f7e1d-8c3a-4f6b-9d5e-2c1b8a3f7d9e",
                                Properties: new DetourRoadEvent(
                                    CoreDetails: new RoadEventCoreDetails(
                                        EventType: EventType.Detour,
                                        DataSourceId: "ef96bc81-3249-495a-aa54-68c5b417cceb",
                                        RoadNames: ["I-82", "I-37"],
                                        Direction: RoadDirection.Southbound,
                                        Name: "Detour 1",
                                        RelatedRoadEvents:
                                        [
                                            new RelatedRoadEvent(
                                                Id: "4fee99c9-e138-4a21-87ba-297ca22234ab",
                                                Type: RelatedRoadEventType.RelatedWorkZone
                                                )
                                        ],
                            ...
                            },
                            {
                                ...
                                "properties": {
                                    "core_details": {
                                        ...
                                        "related_road_events": [
                                            {
                                                "type": "related-work-zone",
                                                "id": "4fee99c9-e138-4a21-87ba-297ca22234ab"
                                            }
                                        ],
                                        "description": "Single direction detour with lane-level information.",
                                        "creation_date": "2024-06-17T18:00:00+00:00",
                                        "update_date": "2024-06-18T14:37:31+00:00",
                                        "relationship": {
                                            "first": [
                                                "4fee99c9-e138-4a21-87ba-297ca22234ab"
        ...
        private const string TestValidWorkZoneFeed = """
            {
                "feed_info": {
    ...
    {
        const string invalidFeedJson = "test";
